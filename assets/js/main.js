...
// $scope.abrirModal = function(nome) {
//     $(`#${nome}`).modal({ backdrop: "static", keyboard: false });
// };

// $scope.fecharModal = function(nome) {
//     $(`#${nome}`).modal("hide");
// };
// $scope.abrirModal('pikachu'); // Para abrir o modal do Pikachu
// $scope.abrirModal('charizard'); // Para abrir o modal do Charizard
